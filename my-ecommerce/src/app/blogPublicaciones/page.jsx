    ...
    <main>
      <section id="publicaciones-container" className={style.contenedores}>
        ...
        <div className={style.publicacion}>
          ...
          <Image className={style.img} src="/images/inmuno.jpg" alt="Imagen de la publicación" width={500} height={400} />
        ...
        <div className={style.post_date}>1 de julio 2023</div>
          ...
          <Image className={style.img} src="/images/propolis.jpg" alt="Imagen de la publicación" width={550} height={550} />
